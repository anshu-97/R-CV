...
\paragraphstyle{My research interests lie in emotional regulation, particularly in investigating its association with interoception and personality traits. I am also fascinated by the psychopathology underlying psychotic and mood disorders, as well as the role mindfulness-based treatments play in alleviating its symptoms.}
...
tibble:: tribble(
  ...
  'Research Assistant', '10-2021, Present', 'Clinical Brain Lab', 'Nanyang Technological University', c('Coordinate project meetings and facilitate communication among project personnel',
    ...
    'Perform EEG, physiological and behavioural data collection',
    'Coordinate data collection and cognitive training sessions.',
    'Assist in the prepartion and writing of progress reports, scientific presentations, manuscripts, abstracts and publications',
...
tibble:: tribble(
  ...
  'Special Education Teacher', '08-2020, 05-2021', 'Fernvale Garden School', 'Movement for the Intellectually Disabled', c('Taught students (7 - 18 year olds) with moderate to severe neurodevelopmental disorders',
'Teach students different coping mechanisms to manage behavioural disorders',
'Support students’ learning using a range of different teaching strategies and handmade as well as self-sourced IT resources',
'Kept classrooms organized, clean, neat and properly sanitized for student health and classroom efficiency'),
) |> 
  detailed_entries(what=title, when=date, with=company, where=location, why=desc, .protect=TRUE)
```
...
tibble:: tribble(
  ...
  "Volunteer", "Children's Partnership Pte Ltd (Singapore)", "2019"
)|> 
