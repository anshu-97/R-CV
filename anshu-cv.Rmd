...
tibble:: tribble(
  ...
  'ABC Lab', '05-2021, 10-2021', 'Research Assistant', 'Singapore Management University', c('Recruit subjects on and off campus',
...
tibble:: tribble(
  ~title, ~date, ~company, ~location, ~desc,
  'Clinical and Health Psychology Centre', '01-2024, 06-2024', 'Clinical Psychologist Trainee', 'National University of Singapore', c('Conduct intervention and neuropsychological assessments for both adults and children'),
  ...
  'ABC Lab', '05-2021, 10-2021', 'Research Assistant', 'Singapore Management University', c('Screen older adults for neurocognitive deficits using assessment tools'),
