...
tibble:: tribble(
  ...
  'Research Assistant', '05-2021, 10-2021', 'ABC Lab', 'Singapore Management University', c('Recruit subjects on and off campus',
    ...
    'Assisting in the preparation and writing of scientific presentations, abstracts, manuscripts and publications',
    'Train and mentor other research assistants and student assistants')
) |> 
...
tibble:: tribble(
  ~title, ~date, ~company, ~location, ~desc,
  'Clinical Psychology Intern', '01-2024, 06-2024', 'Clinical and Health Psychology Centre', 'National University of Singapore', c('Conduct intervention and neuropsychological assessments for both adults and children'),
...
tibble:: tribble(
  ...
  "National University of Singapore", "Master of Psychology (Clinical)", "Singapore", "2023 - 2025", c("Master's Dissertation: Exploring Latent Profiles in Informant Discrepancies: A Study of Youth Behaviour in Singapore"),
    "National University of Singapore", "Bachelor of Social Sciences with Honors (Highest Distinction) in Psychology", "Singapore", "2016 - 2020", c("Honors Thesis: What Happens After we Choose to Eat the Forbidden Fruit - Effects of Indulgence Autonomy on Post-Temptation Motivation"),)|> 
